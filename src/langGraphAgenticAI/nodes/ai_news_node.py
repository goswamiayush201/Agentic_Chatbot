...
class AINewsNode:
    ...
    def fetch_news(self,state: dict)-> dict:
        ...
        frequency = msg[0].lower() if isinstance(msg, list) else msg.lower()
    ...
    def summarize_news(self, state:dict)-> dict:
        ...
        prompt_template=ChatPromptTemplate.from_messages([
            (
                "system","""Summarise AI news articles into markdown format.For each item include:
        ...
        articles_str="\n\n".join([
            ...
            for item in self.state['news_data']
        ])
